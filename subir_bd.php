...
if (isset($_POST['nombre']) && !empty($_POST['nombre']) &&
  ...
  mysqli_query($db_connection, "INSERT INTO `principal` (`Id`, `Nombre_proyecto`, `Nombre_responsable`, `Descripcion`, `Prioridad`, `Points`, `Tipo`, `Fecha_Creacion`) VALUES (NULL, '$nombre', '$responsable', '$descripcion', '$prioridad', '$puntos', '$tipo_proyec', '$fecha')");
